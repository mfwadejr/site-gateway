...
function advancedFormBody(form, body) {
  ...
  body.hsts = form.has("hsts"); body.hstsSubdomains = form.has("hstsSubdomains"); body.healthEnabled = monitoringChecked(form, "proxy"); body.upstreamTlsInsecure = form.has("upstreamTlsInsecure");
